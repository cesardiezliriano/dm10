...
const UI_STRINGS: Record<UIStringKeys, Record<Language, string> | Partial<Record<Language, string>>> = {
  ...
  HISTORY_TAB_AGGREGATED: {
    [Language.EN]: "Aggregated",
    [Language.ES]: "Agregados"
  },
  HISTORY_TAB_STRUCTURED: {
    [Language.EN]: "Summary",
    [Language.ES]: "Resúmenes"
  },
  HISTORY_EMPTY_STATE: {
    [Language.EN]: "No history available yet. Generate an insight to see it here.",
    [Language.ES]: "Aún no hay historial. Genera un insight para verlo aquí."
  },
  HISTORY_ITEM_DELETE_TOOLTIP: {
    [Language.EN]: "Delete Item",
    [Language.ES]: "Eliminar Ítem"
  },
  HISTORY_ITEM_LOAD_BUTTON: {
    [Language.EN]: "Load Data",
    [Language.ES]: "Cargar Datos"
  },
  HISTORY_CLEAR_ALL: {
